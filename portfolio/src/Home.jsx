  ...
  return (
    <div className="bg-[#0a192f] w-full h-screen px-8">
      <div className="max-w-[1000px] mx-auto px-6 flex flex-col justify-center h-full">
        ...
        <div>
        <button className="border-2 rounded-md shadow-xl shadow-blue-400 border-white text-white mt-4 hover:bg-blue-400 ease-in duration-700 hover:border-blue-400 px-6 py-3 ">Download Resume</button>
      </div>
      </div>
